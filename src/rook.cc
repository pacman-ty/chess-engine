...
std::vector<Move> Rook::getPossibleMoves(const Board::BoardType & curBoard) const {
...
std::vector<Move> Rook::getPossibleCaptures(const Board::BoardType & curBoard) const {
    std::vector<Move> output;
    int curX = currPosition.getX();
    int curY = currPosition.getY();
